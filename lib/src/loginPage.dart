...
import 'package:helping_hand/src/forgotPassword.dart';
import 'package:flutter/material.dart';
import 'package:helping_hand/src/signup.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void login(String email, String password) async{
    ...
    if(errorMessage != null){
      ...
      Firestore.instance
        .collection("userdata").where('email', isEqualTo: email)
        .getDocuments()
